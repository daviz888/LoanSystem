...
namespace LoanSystem.WebUI.Controllers
{
    public class InterestController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "InterestID,InterestRate,InterestYear")] Interest interest)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "InterestID,InterestRate,InterestYear")] Interest interest)
        {
            if (ModelState.IsValid)
            {
